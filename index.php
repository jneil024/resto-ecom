...
<style>
    ...
    .hero-inner {
        animation: fadeInFromBottom 1.5s ease-in-out forwards !important;
    }

    .steps {
        animation: fadeInFromBottom 2s ease-in-out forwards !important;
    }
...
.how-it-works-steps:nth-child(3) {
...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/bh.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1 style="font-size: 150px!important;">Isabel's Treats </h1>
                <h1 style="font-size: 30px!important; margin-top: -40px !important;">Order Delivery & Take-Outs </h1>
                ...
                <div class="steps" style="animation: fadeInFromRight 0.5s ease-in-out forwards important; ">
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2 class="p-1" style="background-color:#4e8a3e; color: white; border-radius: 10px;">Popular Dishes of the Month</h2>
            ...
            <div class="row" >
                ...
                while ($r = mysqli_fetch_array($query_res)) {
                    ...
                    echo '  <div class="p-0 col-xs-12 col-sm-6 col-md-4 food-item" style="border: solid 2px yellow; border-radius: 20px;">
                                            <div class="food-item-wrap m-0" style="border-radius: 20px">
