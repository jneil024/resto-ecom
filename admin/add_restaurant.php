    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <a class="navbar-brand" href="dashboard.php"> <img class="img-rounded" src="images/logo.png" alt="" height="35px"></a>  
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="all_users.php"> <span><iclass="fa fa-user f-s-20 "></i></span><span>Users</span></a></li>
                        <li> <a href="staff.php"> <span><i class="fa fa-user f-s-20 "></i></span><span>staff</span></a></li>
