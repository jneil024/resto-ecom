...
if (isset($_POST['submit'])) {
   if (
      ...
      if ($_POST['password'] != $_POST['cpassword']) {
         ...
         $mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address) VALUES('" . $_POST['username'] . "','" . $_POST['firstname'] . "','" . $_POST['lastname'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . $hashed_password . "','" . $_POST['address'] . "')";
...
<body>
   <div style=" background-image: url('images/bh.jpg');">
      <!----pa bago ng bg=====----->
